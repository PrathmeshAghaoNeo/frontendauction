...
export const routes: Routes = [
  ...
  },
  {
    ...
    component: DashboardComponent,
    canActivate: [RoleGuard],
    data: { role: ['Admin', 'Supplier', 'SuperAdmin', 'OnlyManageAssets'], animation: 'Categories' },
  },
  {
    path: 'roles',
  ...
  },
  {
    ...
    canActivate: [RoleGuard],
    data: { role: 'Admin', animation: 'Reports' },
  },
  {
    path: 'view-request',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { animation: 'SettingsPrivacy' },
      },
      {
        path: 'deposit-limit',
        component: DepositLimitComponent,
        data: { animation: 'DepositLimit' },
      },
      {
        path: 'refund-request',
        component: RefundRequestComponent,
        data: { animation: 'RefundRequest' },
      },
      {
        path: 'transaction-history',
        component: UserTransactionsComponent,
        data: { animation: 'TransactionHistory' },
      },
      {
        path: 'my-purchases',
        component: MyPurchasesComponent,
        data: { animation: 'MyPurchases' },
      },
  ...
  },
  {
    ...
    data: { animation: 'PaymentSuccess' },
  },
  { path: 'testing', component: ChartComponent, data: { animation: 'Chart' } },
  {
    path: 'updateRole/:id',
    component: RoleUpdateComponent,
    data: { animation: 'UpdateRole' },
  },
  {
    path: 'createRole',
    component: RoleCreateComponent,
    data: { animation: 'CreateRole' },
  },
  {
    path: 'user-signup',
    component: UserSignupComponent,
    data: { animation: 'UserSignup' },
  },
  {
    path: 'asset-details',
    component: AssetDetailComponent,
    data: { animation: 'AssetDetails' },
  },
  {
    path: 'audit-trial',
    component: AuditTrailComponent,
    data: { animation: 'AuditTrail' },
  },
  {
    path: 'direct-sale-assetpage/:assetId',
    component: DirectSaleAssetComponent,
    data: { animation: 'DirectSaleAsset' },
  },
  {
    path: 'order-details/:assetId',
    component: GetOrderDetailsComponent,
    data: { animation: 'OrderDetails' },
  },
  {
    path: 'direct-sale-assets/:categoryId',
    component: DirectSaleAssetsComponent,
    data: { animation: 'DirectSaleAssets' },
  },
  {
    path: 'auction-assets/:categoryId',
    component: AuctionAssetsComponent,
    data: { animation: 'AuctionAssets' },
  },
  {
    path: 'signal',
    component: SignalrTestComponent,
    data: { animation: 'SignalrTest' },
  },
  {
    path: 'bid-watchlist',
    component: BidWatchlistComponent,
    data: { animation: 'BidWatchlist' },
  },
  {
    path: 'bid-add-to-cart',
    component: BidAddToCartComponent,
    data: { animation: 'BidAddToCart' },
  },
  {
    path: 'page-not-found',
  ...
  {
    path: 'orders',
    component: GetOrdersComponentComponent,
    data: { animation: 'Orders' },
  },
  {
    path: 'refund-request',
    component: RefundRequestComponent,
    data: { animation: 'RefundRequestDuplicate' },
  },
  {
    path: 'deposit-page',
    component: DepositPageComponent,
    data: { animation: 'DepositPage' },
  },
  {
    path: 'bid-history',
    component: BidHistoryComponent,
    data: { animation: 'BidHistory' },
  },
  {
    path: 'chatbot-admin',
  ...
  {
    path: 'finalCheckout/:assetId',
    component: CheckoutComponentComponent,
    data: { animation: 'FinalCheckout' },
  },
